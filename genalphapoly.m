...
% [alphacand, wczetacand] = genalphapoly(wczetacand, l, T)
% or
% [alphacand, wczetacand] = genalphapoly(wc, zeta, sfactor, l, T)

%%
if(nargin == 3)	% Generate alphacand given wczetacand, l and T
...
elseif(nargin >= 5)	% Generate alphacand and wczetacand given wc, zeta, sfactor, l and T
